...
public:
	...
	*/
	...
	/**
	* \brief Metodo que retorna a matriz com as primeiras aproximações dos parametros da orienta�oes exteriores
	* \param    M12  : Matriz M12
	* \param    m1   : Matriz m1
	* \param    xypf : Matriz xypf, matriz com as primeiras aproximaçoes das coordenadas dos pontos fotogrametricos
	* \return Matrix : Matriz paf, matriz com as primeiras aproximaçoes dos parametros da orienta�ao exterior
	*/
	Matrix getPAf(Matrix M12,Matrix m1, Matrix xypf);

	/**
	* \brief Metodo que retorna a matriz com as primeiras aproxima�oes das coordernadas dos pontos fotogrametricos
	...
	*/
	...
	/**
	* \brief Metodo que retorna apenas os coeficientes de uma fun�ao afim para converter coordenada analogica(xsi,eta) para coordenada de terreno
...
protected:
	...
	*/
	...
	/**
	* \brief Calcula e altera a matrix x1 a qual e a matriz que contem os "deltas" a serem somados nos parametros da orienta�ao exterior
...
//	Eigen::MatrixXd convertMatrixToEigen(Matrix mat);
	...
	* \param img : Imagem cujo posi�ao na lista deseja-se saber
	* \return int : posi��o na lista de imagens
	*/
	...
	* \param sys : Sistema geodesico no qual as coordenadas est�o
	* \param hemi : inteiro informando em qual hemisferio est�o as coordenadas; i.e. -1=Sul +1=Norte
	* \param zona : Zona na qual as coordenadas est�o
	...
	* \param coordinates : Matrix contendo as coordenadas( matrix de ajustamento)
	* \param sys : Sistema geodesico no qual as coordenadas dever�o estar
