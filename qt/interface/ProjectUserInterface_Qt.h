...
class ProjectUserInterface_Qt : public QMainWindow,
                                public Ui::ProjectMainWindow,
                                public ProjectUserInterface {
  Q_OBJECT

 public:
  explicit ProjectUserInterface_Qt(ProjectManager* manager, QWidget* parent = 0,
 ...
 public:
  ...
  QString getSavedIn();
  std::string pointTxtToXml(QString point, int key, int line,
                            std::string typePoint = "control");
  std::string edomPointToTxt(EDomElement points);

  std::string pointTxtToXml2(QString point, int key /*, int line*/,
                             std::string typePoint = "photogrammetric");

  EDomElement imageTxtToXml(
      /*QString image, int key, int line, int sensorKey=0, int flightKey=0*/);
  ...
  void updatePath();
  void saveSettings(std::string setting, std::string value);
 ...
 public slots:
  ...
  std::string addImageXml(QString fileName, int keyImage, int widthImages,
                          int heightImages, int dpi = 0);
