...
SensorForm::SensorForm(QWidget* parent): AbstractForm(parent)
{
    ...
    connect(fiducialMarksCombo, SIGNAL(currentIndexChanged(int)), this,
            SLOT(fiducialGroup(int)));
    //newSensor
    connect(calcModelComboBox, SIGNAL (currentIndexChanged(int)), this,
            SLOT(calculationMode(int)));
    connect(sensorColsSpinBox, SIGNAL(valueChanged(int)), this,
            SLOT(updateSensorDiagonal()));
    connect(sensorRowsSpinBox, SIGNAL(valueChanged(int)), this,
            SLOT(updateSensorDiagonal()));
    connect(pixelSizeDoubleSpinBox, SIGNAL(valueChanged(double)), this,
            SLOT(updateSensorDiagonal()));
}
...
void SensorForm::fillvalues(std::string values)
{
    ...
    bool ok;
    sensorIdLineEdit->setText(QString::fromUtf8(
                                  ede.elementByTagName("sensorId").toString().c_str()));
    geometryCombo->setCurrentIndex(geometryCombo->findText(QString::fromUtf8(
                                       ede.elementByTagName("geometry").toString().c_str())));
    platformCombo->setCurrentIndex(platformCombo->findText(QString::fromUtf8(
                                       ede.elementByTagName("platform").toString().c_str())));
    detectorCombo->setCurrentIndex(detectorCombo->findText(QString::fromUtf8(
                                       ede.elementByTagName("detector").toString().c_str())));
    energyCombo->setCurrentIndex(energyCombo->findText(QString::fromUtf8(
                                     ede.elementByTagName("energySource").toString().c_str())));

    if (ede.hasTagName("calculationMode")) {
        calcModelComboBox->setCurrentIndex(calcModelComboBox->findText(
                                               QString::fromUtf8(
                                                       ede.elementByTagName("calculationMode").toString().c_str()))); //newSensor
    ...
    descriptionTextEdit->setPlainText(QString::fromUtf8(
                                          ede.elementByTagName("description").toString().c_str()));
    cameraNumberLineEdit->setText(QString::fromUtf8(
                                      ede.elementByTagName("number").toString().c_str()));
    ...
    if (ede.elementByTagName("dispatch").getContent() != "") {
        cameraDispatchDateEdit->setDate(QDate::fromString(QString::fromUtf8(
                                            ede.elementByTagName("dispatch").toString().c_str()), Qt::ISODate));
    }

    if (ede.elementByTagName("expiration").getContent() != "") {
        cameraExpirationDateEdit->setDate(QDate::fromString(QString::fromUtf8(
                                              ede.elementByTagName("expiration").toString().c_str()), Qt::ISODate));
    }

    if (ede.elementByTagName("value").getContent() != "") {
        calibratedFocalDistanceDoubleSpin->setValue(QString::fromUtf8(
                    ede.elementByTagName("value").toString().c_str()).toDouble(&ok));
    }

    calibratedSigmaController->fillValues(
        ede.elementByTagName("sigma").getContent());
    EDomElement k;
    EDomElement cons;
    ...
    if (ede.hasTagName("radialSymmetric")) {
        ...
        radialK0LineEdit->setTextValue(QString::fromUtf8(
                                           k.elementByTagName("value").toString().c_str()));
        k = ede.elementByTagName("k1");
        radialK1LineEdit->setTextValue(QString::fromUtf8(
                                           k.elementByTagName("value").toString().c_str()));
        k = ede.elementByTagName("k2");
        radialK2LineEdit->setTextValue(QString::fromUtf8(
                                           k.elementByTagName("value").toString().c_str()));
        k = ede.elementByTagName("k3");
        radialK3LineEdit->setTextValue(QString::fromUtf8(
                                           k.elementByTagName("value").toString().c_str()));
        radialSigmaController->fillValues(
            ede.elementByTagName("radialSymmetric").elementByTagName("sigma").getContent());
    }
    else {
    ...
    if (ede.hasTagName("decentered")) {
        ...
        decenteredP1LineEdit->setTextValue(QString::fromUtf8(
                                               k.elementByTagName("value").toString().c_str()));
        k = ede.elementByTagName("P2");
        decenteredP2LineEdit->setTextValue(QString::fromUtf8(
                                               k.elementByTagName("value").toString().c_str()));
        decenteredSigmaController->fillValues(
            ede.elementByTagName("decentered").elementByTagName("sigma").getContent());
    }
    else {
    ...
    */ //Feito a seguir:
    ...
    if (pri.elementByTagName("gml:pos").toString() != "") {
        principalX0doubleSpin->setValue(QString::fromUtf8(
                                            pri.elementByTagName("gml:pos").toString().c_str()).split(" ").at(
                                            0).toDouble());
        principalY0doubleSpin->setValue(QString::fromUtf8(
                                            pri.elementByTagName("gml:pos").toString().c_str()).split(" ").at(
                                            1).toDouble());
    }
    else {
    ...
    principalSigmaController->fillValues(
        pri.elementByTagName("sigma").getContent());
    ...
    if (calcModelComboBox->currentIndex() == 0) {
        ...
        if (fids.children().size() == 0) {
            ...
            fiducialMarksCombo->setCurrentIndex(fiducialMarksCombo->findText(
                                                    QString::number(fids.children().size()) + " marks"));
            fiducialGroup(fiducialMarksCombo->currentIndex());
        }
        ...
        if (fid.elementByTagName("gml:pos").toString() != "") {
            fiducialXi0doubleSpin->setValue(QString::fromUtf8(
                                                fid.elementByTagName("gml:pos").toString().c_str()).split(" ").at(
                                                0).toDouble());
            fiducialEta0doubleSpin->setValue(QString::fromUtf8(
                                                 fid.elementByTagName("gml:pos").toString().c_str()).split(" ").at(
                                                 1).toDouble());
        }
        ...
        if (fid.elementByTagName("gml:pos").toString() != "") {
            fiducialXi1doubleSpin->setValue(QString::fromUtf8(
                                                fid.elementByTagName("gml:pos").toString().c_str()).split(" ").at(
                                                0).toDouble());
            fiducialEta1doubleSpin->setValue(QString::fromUtf8(
                                                 fid.elementByTagName("gml:pos").toString().c_str()).split(" ").at(
                                                 1).toDouble());
        }
        ...
        if (fid.elementByTagName("gml:pos").toString() != "") {
            fiducialXi2doubleSpin->setValue(QString::fromUtf8(
                                                fid.elementByTagName("gml:pos").toString().c_str()).split(" ").at(
                                                0).toDouble());
            fiducialEta2doubleSpin->setValue(QString::fromUtf8(
                                                 fid.elementByTagName("gml:pos").toString().c_str()).split(" ").at(
                                                 1).toDouble());
        }
        ...
        if (fid.elementByTagName("gml:pos").toString() != "") {
            fiducialXi3doubleSpin->setValue(QString::fromUtf8(
                                                fid.elementByTagName("gml:pos").toString().c_str()).split(" ").at(
                                                0).toDouble());
            fiducialEta3doubleSpin->setValue(QString::fromUtf8(
                                                 fid.elementByTagName("gml:pos").toString().c_str()).split(" ").at(
                                                 1).toDouble());
        }
        ...
        if (fiducialMarksCombo->currentIndex() == 1) {
            ...
            if (fid.elementByTagName("gml:pos").toString() != "") {
                fiducialXi4doubleSpin->setValue(QString::fromUtf8(
                                                    fid.elementByTagName("gml:pos").toString().c_str()).split(" ").at(
                                                    0).toDouble());
                fiducialEta4doubleSpin->setValue(QString::fromUtf8(
                                                     fid.elementByTagName("gml:pos").toString().c_str()).split(" ").at(
                                                     1).toDouble());
            }
            ...
            if (fid.elementByTagName("gml:pos").toString() != "") {
                fiducialXi5doubleSpin->setValue(QString::fromUtf8(
                                                    fid.elementByTagName("gml:pos").toString().c_str()).split(" ").at(
                                                    0).toDouble());
                fiducialEta5doubleSpin->setValue(QString::fromUtf8(
                                                     fid.elementByTagName("gml:pos").toString().c_str()).split(" ").at(
                                                     1).toDouble());
            }
            ...
            if (fid.elementByTagName("gml:pos").toString() != "") {
                fiducialXi6doubleSpin->setValue(QString::fromUtf8(
                                                    fid.elementByTagName("gml:pos").toString().c_str()).split(" ").at(
                                                    0).toDouble());
                fiducialEta6doubleSpin->setValue(QString::fromUtf8(
                                                     fid.elementByTagName("gml:pos").toString().c_str()).split(" ").at(
                                                     1).toDouble());
            }
            ...
            if (fid.elementByTagName("gml:pos").toString() != "") {
                fiducialXi7doubleSpin->setValue(QString::fromUtf8(
                                                    fid.elementByTagName("gml:pos").toString().c_str()).split(" ").at(
                                                    0).toDouble());
                fiducialEta7doubleSpin->setValue(QString::fromUtf8(
                                                     fid.elementByTagName("gml:pos").toString().c_str()).split(" ").at(
                                                     1).toDouble());
            }
        ...
        pixelSizeDoubleSpinBox->setValue(QString::fromUtf8(
                                             sensorDimensions.elementByTagName("pixelSize").toString().c_str()).toDouble());
        sensorRowsSpinBox->setValue(QString::fromUtf8(
                                        sensorDimensions.elementByTagName("rows").toString().c_str()).toDouble());
        sensorColsSpinBox->setValue(QString::fromUtf8(
                                        sensorDimensions.elementByTagName("columns").toString().c_str()).toDouble());
        xaA0SpinBox->setValue(0);
        xaA1SpinBox->setValue(0);
        xaA2SpinBox->setValue(0);
        xaB0SpinBox->setValue(0);
...
std::string SensorForm::getvalues()
{
    ...
    auxStream << "<sensorId>" << sensorIdLineEdit->text().toUtf8().data() <<
              "</sensorId>\n";
    auxStream << "<type>\n" ;
    auxStream << "<geometry>" << geometryCombo->currentText().toUtf8().data() <<
              "</geometry>\n";
    auxStream << "<platform>" << platformCombo->currentText().toUtf8().data() <<
              "</platform>\n";
    auxStream << "<detector>" << detectorCombo->currentText().toUtf8().data() <<
              "</detector>\n";
    auxStream << "<energySource>" << energyCombo->currentText().toUtf8().data() <<
              "</energySource>\n";
    auxStream << "<calculationMode>" <<
              calcModelComboBox->currentText().toUtf8().data() <<
              "</calculationMode>\n"; //new form sensor
    auxStream <<
              "<spectralRanges uom=\"#um\"><!--#um equivale a dez elevado a menos seis metros-->\n";
    auxStream << "<spectralRange band=\"1\">\n"; // aqui tem um valor travado
    auxStream <<
              "<inferiorLimit>0.4</inferiorLimit>\n"; // aqui tem um valor travado
    auxStream <<
              "<superiorLimit>0.7</superiorLimit>\n"; // aqui tem um valor travado
    auxStream << "</spectralRange>\n";
    auxStream << "</spectralRanges>\n";
    auxStream << "</type>\n";
    auxStream << "<description>" <<
              descriptionTextEdit->toPlainText().toUtf8().data() << "</description>\n";
    auxStream << "<calibrationCertificate>\n" ;
    auxStream << "<number>" << cameraNumberLineEdit->text().toUtf8().data() <<
              "</number>\n";
    auxStream << "<dispatch>" << cameraDispatchDateEdit->dateTime().toString(
                  Qt::ISODate).toUtf8().data() << "</dispatch>\n";
    auxStream << "<expiration>" << cameraExpirationDateEdit->dateTime().toString(
                  Qt::ISODate).toUtf8().data() << "</expiration>\n";
    auxStream << "</calibrationCertificate>\n";
    auxStream << "<focalDistance uom=\"#mm\">\n";
    auxStream << "<value>" << calibratedFocalDistanceDoubleSpin->value() <<
              "</value>\n";
    ...
    if (radSymmetricGroupBox->isChecked()) {
        ...
        auxStream << "<k0>\n";
        auxStream << "<value>" << radialK0LineEdit->textValue().toUtf8().data() <<
                  "</value>\n";
        //auxStream << "<sigma>" <<radialSigmaK0LineEdit->text().toUtf8().data() << "</sigma>\n";
        auxStream << "</k0>\n";
        auxStream << "<k1>\n";
        auxStream << "<value>" << radialK1LineEdit->textValue().toUtf8().data() <<
                  "</value>\n";
        //auxStream << "<sigma>" <<radialSigmaK1LineEdit->text().toUtf8().data() << "</sigma>\n";
        auxStream << "</k1>\n";
        auxStream << "<k2>\n";
        auxStream << "<value>" << radialK2LineEdit->textValue().toUtf8().data() <<
                  "</value>\n";
        //auxStream << "<sigma>" <<radialSigmaK2LineEdit->text().toUtf8().data() << "</sigma>\n";
        auxStream << "</k2>\n";
        auxStream << "<k3>\n";
        auxStream << "<value>" << radialK3LineEdit->textValue().toUtf8().data() <<
                  "</value>\n";
    ...
    if (decenteredGroupBox->isChecked()) {
        ...
        auxStream << "<P1>\n";
        auxStream << "<value>" << decenteredP1LineEdit->textValue().toUtf8().data() <<
                  "</value>\n";
        //auxStream << "<sigma>" << decenteredP1SigmaLineEdit->text().toUtf8().data() << "</sigma>\n";
        auxStream << "</P1>\n";
        auxStream << "<P2>\n";
        auxStream << "<value>" << decenteredP2LineEdit->textValue().toUtf8().data() <<
                  "</value>\n";
    ...
    auxStream << "<gml:pos>" <<  principalX0doubleSpin->value() << " " <<
              principalY0doubleSpin->value() << "</gml:pos>\n";
    ...
    if (calcModelComboBox->currentIndex() == 0) {
        ...
        auxStream << "<gml:pos>" << fiducialXi0doubleSpin->value() << " " <<
                  fiducialEta0doubleSpin->value() << "</gml:pos>\n";
        ...
        auxStream << "<gml:pos>" << fiducialXi1doubleSpin->value() << " " <<
                  fiducialEta1doubleSpin->value() << "</gml:pos>\n";
        ...
        auxStream << "<gml:pos>" << fiducialXi2doubleSpin->value() << " " <<
                  fiducialEta2doubleSpin->value() << "</gml:pos>\n";
        //auxStream << "<sigma>" << fiducialSigma2doubleSpin->text().toUtf8().data() << "</sigma>\n";
        auxStream << fid2SigmaController->getValues();
        auxStream << "</fiducialMark>\n";
        auxStream << "<fiducialMark key=\"4\">\n";
        auxStream << "<gml:pos>" << fiducialXi3doubleSpin->value() << " " <<
                  fiducialEta3doubleSpin->value() << "</gml:pos>\n";
        ...
        if (fiducialMarksCombo->currentIndex() == 1) {
            ...
            auxStream << "<gml:pos>" << fiducialXi4doubleSpin->value() << " " <<
                      fiducialEta4doubleSpin->value() << "</gml:pos>\n";
            ...
            auxStream << "<gml:pos>" << fiducialXi5doubleSpin->value() << " " <<
                      fiducialEta5doubleSpin->value() << "</gml:pos>\n";
            ...
            auxStream << "<gml:pos>" << fiducialXi6doubleSpin->value() << " " <<
                      fiducialEta6doubleSpin->value() << "</gml:pos>\n";
            ...
            auxStream << "<gml:pos>" << fiducialXi7doubleSpin->value() << " " <<
                      fiducialEta7doubleSpin->value() << "</gml:pos>\n";
        ...
        auxStream << "<pixelSize uom=\"#um\">" << pixelSizeDoubleSpinBox->value() <<
                  "</pixelSize>\n";
