...
Geometry Geometry::createPoint(QPointF coord, unsigned int pointKey, QString label, Marker *mark)
{
    Geometry result;
    result.type_ = 1;
...
Geometry Geometry::createLine(QList<Coord> coords, unsigned int lineKey)
{
    Geometry result;
    result.type_ = 2;
...
Geometry Geometry::createPolygon(QList<Coord> coords, unsigned int polygonKey)
{
    Geometry result;
    result.type_ = 3;
    result.points_.append(coords);
...
void GeometryResource::insertPoint(QPointF location, unsigned int pointKey, QString label, Marker* mark)
{
    if (pointKey == 0)
    {
...
void GeometryResource::addPoint(QPointF location, unsigned int pointKey, QString label, Marker* mark)
{
    if (pointKey == 0)
...
void GeometryResource::updatePoint(QPointF location, unsigned int pointKey, QString label, Marker* mark)
{
    if (pointKey == 0)
    {
        return;
...
void GeometryResource::addLine(QPointF p0, QPointF p1, unsigned int lineKey)
{
    if (lineKey == 0)
