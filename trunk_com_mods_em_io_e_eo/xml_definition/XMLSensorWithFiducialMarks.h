#ifndef XMLSENSORWITHFIDUCIALMARKS_H
#define XMLSENSORWITHFIDUCIALMARKS_H
...
class XMLSensorWithFiducialMarks:XMLSensor
{
	...
	virtual deque<AnalogFiductialMark> SensorWithFiducialMarks::getAnaFidMarks();
    virtual voidputAnaFidMark(AnalogFiductialMark newAnaFidMark);
	virtual AnalogFiductialMark SensorWithFiducialMarks::getAnaFidMark(int id);
	virtual AnalogFiductialMark SensorWithFiducialMarks::getAnaFidMarkAt(unsigned int index);
...
*/
#endif // XMLSENSORWITHFIDUCIALMARKS_H
