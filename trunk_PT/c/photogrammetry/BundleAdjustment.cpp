...
15 iteraÁıes e 4 mudanÁa de pesos
*/
...
*/
    ...
    /*Matrizes das coordenadas dos pontos do bloco. As imagens est√£o representadas nas linhas e os pontos nas
    colunas, onde o n√∫mero da linha √© o mesmo do identificador da imagem e o da coluna, o mesmo do identificador do ponto.
    Valor -1 indica ponto fotogram√©trico, e valor 0 indica ponto n√£o contido na imagem.
    */
    //espaÁo Objeto
    ...
    /* Matriz de configura√ß√£o do bloco. Valor 1 - ponto de controle, valor -1, ponto fotogram√©trico, valor 0, ponto n√£o
...
Matrix BundleAdjustment::createMl(Matrix C, Matrix L)
{
    ...
    for (int i=1;i<rows;i++)
    {
        ...
        //pıe as matrizes diagonalmente em relaÁao a outra
...
int* BundleAdjustment::analogToDigital(Matrix Xa, double xsi, double eta, int indexImg)
{
    ...
    //IdÈia do Rafael Aguiar para contornar erro de cast (somar 0.1)
