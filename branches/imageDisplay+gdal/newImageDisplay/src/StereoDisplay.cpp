...
void GLDisplay::paintGL()
{
    ...
    if (stereoDisplay_->getCurrentScene() == nullptr)
        return;
...
{
    if (leftDisplay_ == nullptr)
    {
        SingleDisplay* result = new SingleDisplay(0, currentScene_ ? currentScene_->getLeftScene() : nullptr);
        leftDisplay_ = result;
    }
    return leftDisplay_;
}
...
{
    if (rightDisplay_ == nullptr)
    {
        SingleDisplay* result = new SingleDisplay(0, currentScene_ ? currentScene_->getRightScene(): nullptr);
