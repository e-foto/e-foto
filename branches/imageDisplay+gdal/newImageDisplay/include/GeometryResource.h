...
public:
    Coord();
    explicit Coord(QPointF location, QString label, Marker* mark = nullptr);
    QString label_;
    Marker* marker_;
};
...
public:
    ...
    static Geometry createPoint(QPointF coord, unsigned int pointKey, QString label = "", Marker* mark = nullptr);
...
public:
    GeometryResource();
    void insertPoint(QPointF location, unsigned int pointKey = 0, QString label = "", Marker* mark = nullptr);
    void addPoint(QPointF location, unsigned int pointKey = 0, QString label = "", Marker* mark = nullptr);
    void updatePoint(QPointF location, unsigned int pointKey = 0, QString label = "", Marker* mark = nullptr);
