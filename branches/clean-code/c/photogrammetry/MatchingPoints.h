...
private:
    ...
    bool push(int, int);
    void emptyStack();
    stackCellQuick *stack;
    double **array;
    void createAuxiliaryList();
    void deleteAuxiliaryList() const;
    void updateList();
    void copyListByLeft();
    ...
    static void drawCross(Matrix *, unsigned int, unsigned int, double);
