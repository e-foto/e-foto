...
public:
    SPManager();
    explicit SPManager(EFotoManager* manager, std::deque<Image*> images,
    ...
    void getSelected(int& fid, int& pid) const
    {
    ...
    void computeIntersection(double xl, double yl, double xr, double yr, double& X_,
                             double& Y, double& Z);
    ...
    void addPoint(int fid, int pid, double lx, double ly, double rx, double ry,
                  double X_, double Y, double Z);
    void updatePoint(int fid, int pid, double lx, double ly, double rx, double ry,
                     double X_, double Y, double Z);
    void setSelectedXYZ(double X_, double Y, double Z);
