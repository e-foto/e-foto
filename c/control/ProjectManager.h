...
class ProjectManager {
 ...
 public:
  ...
  /**
   * \brief Método que inicia um novo projeto, inicia um xml vazio para ser
   * preenchido posteriormente ao longo do projeto. \param filename Nome do
   * arquivo. \return bool Retorna verdadeiro se o novo projeto foi iniciado
   * corretamente. Retorna falso, caso contrário.
   */
   ...
   * \return  bool Retorna verdadeiro se o projeto foi carregado corretamente.
   ...
   * \param  filename Nome do arquivo.
   * \return  bool Retorna verdadeiro se o projeto foi salvado corretamente.
   * Retorna falso, caso contrário.
   */
  bool saveFile(std::string filename);
  /**
   * \brief Método que retorna um inteiro informando que tipo de erro tem o
   * arquivo. \return  int Código de erro que tem o arquivo.
   */
   ...
   * \return bool Retorna verdadeiro se a adição foi realizada corretamente.
   * Retorna falso, caso contrário.
   */
  bool addComponent(std::string data, std::string parent);
  /**
   * \brief Método que remove um nó xml do projeto.
   * \param type : Texto contendo o tipo, a saber: Sensor, Flight,Image, Point,
   * IO, EO. \param  id : Identificacao do componente no XML. \return bool
   * Retorna verdadeiro se a remoção foi realizada corretamente. Retorna falso,
   * caso contrário.
   */
   ...
   * \return bool Retorna verdadeiro se a edição foi realizada corretamente.
   * Retorna falso, caso contrário.
   */
   ...
   * \brief Método que edita um nó no xml do projeto.
   * \param type : Texto contendo o tipo, a saber: Sensor, Flight,Image, Point,
   * IO, EO. \param  id : Identificacao do componente no XML. \param  data :
   * Dados novos a serem inseridos no lugar dos antigos. \return bool Retorna
   * verdadeiro se a edição foi realizada corretamente. Retorna falso, caso
   * contrário.
   */
  ...
  /**
   * \brief Método que retorna um identificador de imagens que ainda não foi
   * utilizado. \return int Identificador da imagem que ainda não foi utilizado.
   */
  int getFreeImageId();
  /**
  ...
  int getFreePointId();
  /**
   * \brief Método que inicia um módulo de Orientação Interior ou Resseção
   * Espacial a partir de um identificador de imagem. \param module Módulo a ser
   * iniciado. \param image Identificador da imagem. \return bool Retorna
   * verdadeiro se o módulo foi iniciado corretamente. Retorna falso, caso
   * contrário.
   */
  bool startModule(std::string module, int image);
  /**
   * \brief Método que carrega o módulo ProjectManager.
   * \return bool Retorna verdadeiro se o módulo ProjectManager já tiver
   * terminado de ser carregado. Retorna falso, caso contrário.
   */
  bool exec(std::string filename = "");
  /**
   * \brief Método que recarrega o módulo ProjectManager.
   * \return bool Retorna verdadeiro se o módulo ProjectManager tiver
   * recarregado com sucesso. Retorna falso, caso contrário.
   */
  bool reload();
  /**
   ...
   * \return bool Retorna verdadeiro se os arquivos foram criados com sucesso.
   * Retorna falso, caso contrário.
   */
