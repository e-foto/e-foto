...
public:
    ...
    */
    explicit SRManager(EFotoManager* newManager, Terrain* newTerrain,
                       Sensor* newSensor, Flight* newFlight, Image* newImage,
                       InteriorOrientation* newIO, SpatialRessection* newSR,
    ...
    */
    void flightDirection(double kappa0);
