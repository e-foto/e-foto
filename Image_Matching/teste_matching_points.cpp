...
#include "MatchingPointsGrid.cpp"
...
//	myList.save((char *)"lista_final_sorted.txt", MatchingPointsList::savePairsHann);
//	myList.sortList(MatchingPointsList::by3D);
//	myList.save((char *)"lista_final_sorted.txt", MatchingPointsList::saveXYZ);

/*
	// Bounding box
	double xi, yi, xf, yf;
	myList.XYZboundingBox(xi, yi, xf, yf);
	printf("Bounding box: %f, %f, %f, %f\n",xi, yi, xf, yf);
*/

	// Using intelligent structure for interpolating points (XYZ)
	MatchingPointsGrid mpg(&myList, 1.0, 1.0);
	mpg.getNearestPoint(681000.0,7465000.0);
//	mpg.getPointsClose(681000.0,7465000.0,5.0);
