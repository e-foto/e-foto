...
public:
    explicit StereoTool(StereoDisplay* display) {_display = display; QTimer *timer = new QTimer(this); _scale = -1; _scaleSpin = nullptr; _leftPosLabel = nullptr; _rightPosLabel = nullptr; _3dPosLabel = nullptr;
...
public:
    ...
    void addMark(QPointF lPos, QPointF rPos, int key, QString label = "", Marker* marker = nullptr);
    void insertMark(QPointF lPos, QPointF rPos, int key, QString label = "", Marker* marker = nullptr);
    //void editMark(int key, QPointF lPos, QPointF rPos, Marker* marker = nullptr);
    //void editMark(int key, QPointF lPos, QPointF rPos, QString label, Marker* marker = nullptr);
